...
开发者可以引用CMake Target：**aimrt::interface::aimrt_pkg_c_interface**，在其中的头文件[aimrt_pkg_c_interface/pkg_main.h](../../../src/interface/aimrt_pkg_c_interface/pkg_main.h)中，定义了4个要实现的接口：
