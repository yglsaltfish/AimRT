...
// 定义一个 MockPlugin 类，继承自 AimRTCorePluginBase
...
// 定义一个 PluginManagerTest 类，继承自 ::testing::Test
...
TEST_F(PluginManagerTest, Initialize1) {
...
TEST_F(PluginManagerTest, Initialize2) {
  MockPlugin* mock_plugin_ptr_ = new MockPlugin();
...
plugins: 
  ...
  plugin_manager_.RegisterPlugin(mock_plugin_ptr_);
