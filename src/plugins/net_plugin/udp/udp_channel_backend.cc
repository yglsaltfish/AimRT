...
struct convert<aimrt::plugins::net_plugin::UdpChannelBackend::Options> {
  using Options = aimrt::plugins::net_plugin::UdpChannelBackend::Options;
...
bool UdpChannelBackend::Subscribe(
  ...
  AIMRT_INFO("Register udp handle for channel, uri '{}'", pattern);
    ...
    boost::asio::co_spawn(
        *io_ptr_,
        [this, publish_add, msg_buf_ptr]() -> boost::asio::awaitable<void> {
          ...
          net::AsioUdpClient::Options client_options{
