...
typedef enum {
  ...
  AIMRT_RPC_STATUS_CLI_BACKEND_INTERNAL_ERROR = 2001,
  AIMRT_RPC_STATUS_CLI_INVALID_CONTEXT = 2002,
  AIMRT_RPC_STATUS_CLI_INVALID_ADDR = 2003,
  AIMRT_RPC_STATUS_CLI_INVALID_SERIALIZATION_TYPE = 2004,
  AIMRT_RPC_STATUS_CLI_SERIALIZATION_FAILED = 2005,
  AIMRT_RPC_STATUS_CLI_INVALID_DESERIALIZATION_TYPE = 2006,
  AIMRT_RPC_STATUS_CLI_DESERIALIZATION_FAILED = 2007,
  AIMRT_RPC_STATUS_CLI_NO_BACKEND_TO_HANDLE = 2008,
  AIMRT_RPC_STATUS_CLI_SEND_REQ_FAILED = 2009,
