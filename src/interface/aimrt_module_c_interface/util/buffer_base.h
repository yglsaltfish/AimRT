...
typedef struct aimrt_buffer_array_allocator_t aimrt_buffer_array_allocator_t;
 ...
 *
 */
struct aimrt_buffer_array_allocator_t {
  /**
   ...
   * Output: New buffer
   */
  aimrt_buffer_t (*allocate)(
      void* impl, aimrt_buffer_array_t* buffer_array, size_t new_buffer_size);
...
/// Unsafe convert aimrt_buffer_array_t to aimrt_buffer_array_view_t
