...
using namespace aimrt::examples::cpp::ros2_rpc::benchmark_rpc_client_module;

template <>
struct convert<BenchmarkRpcClientModule::Options> {
  using Options = BenchmarkRpcClientModule::Options;
...
co::Task<void> BenchmarkRpcClientModule::BenchStatisticsLoop() {
...
co::Task<void> BenchmarkRpcClientModule::FixedFreqStatisticsLoop() {
...
co::Task<void> BenchmarkRpcClientModule::BenchLoop(
...
co::Task<void> BenchmarkRpcClientModule::FixedFreqLoop(
