...
namespace aimrt::examples::cpp::protobuf_rpc::normal_rpc_sync_client_module {
  ...
  try {
    ...
    while (run_flag_) {
      ...
      // call rpc 1
      {
        ...
        auto status = proxy.GetFooData(ctx, req, rsp);
      ...
      // call rpc 2
      {
        ...
        auto status = proxy.GetBarData(ctx, req, rsp);
