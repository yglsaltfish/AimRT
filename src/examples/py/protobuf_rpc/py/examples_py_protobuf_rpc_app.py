...
import sys
import aimrt_py
import normal_rpc_client_module
import normal_rpc_server_module
...
def run_aimrt_core(args):
    try:
        ...
        rpc_client_module = normal_rpc_client_module.NormalRpcClientModule()
        core.RegisterModule(rpc_client_module)

        rpc_server_module = normal_rpc_server_module.NormalRpcServerModule()
